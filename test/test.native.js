...
tape( 'if provided `alpha <= 4`, the function returns `NaN`', opts, function test( t ) {
	var y;
...
tape( 'the function returns the excess kurtosis of an inverse gamma distribution', opts, function test( t ) {
	var expected;
	var delta;
	var alpha;
	var beta;
